...
var translations = {
  en: {
    ...
    content_request:
      "We kindly ask you to update your browser to be able to visit this site",
  },
  ru: {
    name: "Рус",
    ...
    content_request:
      "Мы просим вас обновить браузер, чтобы иметь возможность посещать этот сайт",
  },
  hy: {
    name: "Հայ",
    title: "Դուք օգտագործում եք Internet Explorer «զննարկիչ»",
    content_info:
      "Բարեբախտաբար, թե դժբախտաբար մենք չենք աջակցում տվյալ զննարկիչը",
    content_request:
      "Խնդրում ենք թարմացնել ձեր զննարկիչը, որպեսզի հնարավորություն ունենաք այցելել տվյալ կայքը",
  },
};
...
function initialRender() {
  ...
  for (var lang in translations) {
    // because Object.keys has started to be supported from ie9
